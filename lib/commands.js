...
var converter = function converter(arr) {
  return (0, _util.curry)(function (inputFile, options, outputFile, format, cb) {
    (0, _util.compose)(executeCmd(cb), (0, _util.K)(console.log), (0, _util.concat)(_options.FFMPEG), (0, _util.concat)(_options.INPUT), (0, _util.concat)(inputFile), (0, _util.concat)((0, _util.makeOptions)(options)), (0, _util.makeFileName)(outputFile), (0, _util.includedFormat)(arr), _util.toLowerCase)(format);
  });
};
