...
var concatConverter = function concatConverter(arr) {
  return (0, _util.curry)(function (inputs, output, format, cb) {
    (0, _util.compose)(executeCmd(cb), (0, _util.K)(console.log), (0, _util.concatWithSpace)(_options.FFMPEG), (0, _util.concatWithSpace)((0, _util.makeOptions)(inputs)), (0, _util.concatWithSpace)('-y'), (0, _util.concatWithSpace)('-filter_complex concat=n=' + inputs.length + ':v=1:a=1'), (0, _util.makeFileName)(output), (0, _util.includedFormat)(arr), _util.toLowerCase)(format);
  });
};
