...
function setMetaData(flags) {
  return flags.map((function (x) {
                  return metaDataFlag(Caml_array.caml_array_get(x, 0), Caml_array.caml_array_get(x, 1));
                })).join(" ");
}

function setCreationTime(t) {
  return setMetaData(/* array */[/* array */[
                "creation_time",
                t
              ]]);
}
